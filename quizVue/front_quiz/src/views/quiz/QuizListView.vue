    ...
    <main>
        <div class='container-fluid px-4'>
            ...
            <ol class='breadcrumb mb-4'>
                <li><a class='float-right' data-bs-toggle='collapse' href='#collapseHelp' role='button'
                            ...
                            <div class='col-sm-3'>
                                <div class='form-check form-switch'>
                                    <input class='form-check-input' type='checkbox' role='switch'
                                        id='flexSwitchCheckChecked' name='useYn' value='Y' checked>
                                </div>
                            </div>
                            <label for='quizCtnt' class='col-sm-1 col-form-label text-end'>문제</label>
                            <div class='col-sm-3'>
                                <input type='text' id='quizCtnt' name='quizCtnt' class='form-control' placeholder='내용' v-model="quizVO.quizCtnt">
                            </div>
                        </div>
                ...
                <div class='card-body'>
                    ...
                    <form id='frmList' name='frmList'>
                        <table class='table'>
                            <thead>
                                <tr>
                                    <th>선택<input type="checkbox"  @click="checkedAll($event.target.checked)"></th>
                                    <th>번호</th>
                                    <th>과목</th>
                                    <th>문제유형</th>
                                    <th>문제명</th>
